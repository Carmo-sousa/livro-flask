...
Revision ID: 2d59eb151dea
Revises: 
Create Date: 2020-10-04 17:17:26.369530
...
def upgrade():
    ...
    op.create_table('user',
                    ...
                    sa.Column('date_created', sa.DateTime(
                        timezone=6), nullable=False),
                    sa.Column('last_update', sa.DateTime(
                        timezone=6), nullable=True),
                    sa.Column('recovery_code', sa.String(
